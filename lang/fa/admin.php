...
return [
    ...
    'settings_fields' => [
        ...
        'media_applications_infographic_hint' => 'در صفحه اصلی زیر بخش محصولات و با عرض کامل نمایش داده می‌شود. برش نمی‌خورد، پس تصویر با هر نسبتی بارگذاری شود کامل دیده می‌شود.',
        'media_applications_infographic_mobile' => 'اینفوگرافیک کاربردها — موبایل',
        'media_applications_infographic_mobile_hint' => 'اختیاری. نسخه‌ی عمودی برای صفحه‌ی گوشی. اگر خالی بماند همان تصویر دسکتاپ استفاده می‌شود.',
