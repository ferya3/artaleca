...
return [
    ...
    'news_title' => 'News & technical insights',
    ...
    'plant_description' => 'How expanded clay aggregate is made, from clay extraction and homogenisation through rotary kiln firing, controlled cooling, grading and loading.',

    'downloads_title' => 'Catalogues & technical documentation',
    'downloads_description' => 'Download the Arta Leca product catalogue, grade datasheets, certificates and installation guidance.',

    'faq_title' => 'Frequently asked questions',
    'faq_description' => 'Answers from the Arta Leca technical desk on grade selection, mix design, shipping and export terms.',

    'contact_title' => 'Contact us',
    'contact_description' => 'Head office in Tehran and plant in Qom. Domestic sales and export desk numbers, email addresses and a direct enquiry form.',

    'quote_title' => 'Request a quotation',
    'quote_description' => 'Send the specification, volume and delivery point, and our sales desk will return a price within one working day.',
];
