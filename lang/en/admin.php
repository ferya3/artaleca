...
return [
    ...
    'settings_groups' => [
        ...
        'support' => 'Support and messengers',
        'copy' => 'Homepage copy',
        'media' => 'Site imagery',
        'seo' => 'SEO settings',
    ...
    'settings_group_intros' => [
        ...
        'support' => 'The WhatsApp number and the Telegram and Rubika handles the support button in the corner of every page uses. Leave one blank and that channel is not offered.',
    ...
    'settings_fields' => [
        'whatsapp_hint' => 'A mobile number with WhatsApp on it. An Iranian mobile can be typed any way you like — it is turned into the right link. Anything else, a landline or a number abroad, needs its country code: +98 21 8888 0011. A national number starting with a zero cannot make a working link and is not offered. Leave it blank and WhatsApp is not offered.',
