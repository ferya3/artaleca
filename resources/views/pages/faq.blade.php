<x-layouts.app>
    ...
    <section class="py-section">
        <div class="container-page max-w-3xl">
                    ...
                    @foreach ($groups as $group => $faqs)
                        <div>
                            ...
                            <div class="divide-y divide-hairline border-y border-hairline">
                                @foreach ($faqs as $faq)
                                    <details class="group">
                                        <summary class="flex cursor-pointer list-none items-start justify-between gap-6 py-5 text-start [&::-webkit-details-marker]:hidden">
                                        ...
                                        <div class="prose-industrial pb-6 text-sm">{!! nl2br(e($faq->answer)) !!}</div>
                                    </details>
                                @endforeach
                            </div>
                        </div>
            ...
            <div class="mt-14 border border-hairline bg-surface-muted p-6 text-center">
