        ...
        <svg width="100%" height="100%">
            <defs>
                <pattern id="granules-far" width="180" height="180" patternUnits="userSpaceOnUse">
                    <circle cx="28" cy="34" r="5" fill="var(--color-brand-500)" fill-opacity="0.07"/>
                    <circle cx="96" cy="20" r="3" fill="var(--color-night-300)" fill-opacity="0.05"/>
                    <circle cx="148" cy="52" r="6" fill="var(--color-brand-600)" fill-opacity="0.06"/>
                    <circle cx="62" cy="88" r="4" fill="var(--color-night-200)" fill-opacity="0.035"/>
                    <circle cx="124" cy="112" r="3.5" fill="var(--color-brand-400)" fill-opacity="0.05"/>
                    <circle cx="22" cy="136" r="7" fill="var(--color-brand-500)" fill-opacity="0.045"/>
                    <circle cx="90" cy="152" r="4.5" fill="var(--color-night-300)" fill-opacity="0.04"/>
                    <circle cx="156" cy="146" r="3" fill="var(--color-brand-300)" fill-opacity="0.055"/>
                </pattern>
            </defs>
        ...
        <svg width="100%" height="100%">
            <defs>
                <pattern id="granules-near" width="260" height="260" patternUnits="userSpaceOnUse">
                    <circle cx="44" cy="52" r="11" fill="var(--color-brand-600)" fill-opacity="0.055"/>
                    <circle cx="164" cy="30" r="7" fill="var(--color-night-400)" fill-opacity="0.03"/>
                    <circle cx="226" cy="104" r="9" fill="var(--color-brand-500)" fill-opacity="0.045"/>
                    <circle cx="112" cy="140" r="13" fill="var(--color-brand-700)" fill-opacity="0.06"/>
                    <circle cx="30" cy="196" r="8" fill="var(--color-night-300)" fill-opacity="0.025"/>
                    <circle cx="196" cy="216" r="10" fill="var(--color-brand-400)" fill-opacity="0.04"/>
                </pattern>
            </defs>
