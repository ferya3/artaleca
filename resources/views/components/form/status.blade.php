...
@if (session('status'))
    <div role="status" class="mb-8 border-s-2 border-green-600 bg-green-50 px-5 py-4 text-sm text-green-900">
        {{ session('status') }}
    </div>
@endif

@if ($errors->any())
    <div role="alert" class="mb-8 border-s-2 border-red-600 bg-red-50 px-5 py-4 text-sm text-red-900">
